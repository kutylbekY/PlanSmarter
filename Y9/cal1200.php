...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php
      ...
      $day6q = mysqli_query($conn, "SELECT * FROM ".$cal."D6");
      $arrayd6 = array();
      while($row = mysqli_fetch_assoc($day6q)) {
        $arrayd6[] = $row;
      }
      $day7q = mysqli_query($conn, "SELECT * FROM ".$cal."D7");
      $arrayd7 = array();
      ...
      if (isset($_POST['choose'])) {
        if ($ok == 0) {
          ...
          $sqlU = mysqli_query($conn, "UPDATE userstable SET Nut='1200cal' WHERE username='".$user."'");
          $planAdded = 1;
